 ...
 *   used to represent and encapsulate all the information needed to call a
 *   method at a later time
 * - This information inludes the method name, the object that owns the method
 *   and values for the method parameters
 * - Allows you to store lists of code that is used at a later time or many times
 * - Client says "I want a specific Command to run when execute() is called on one
 *   of these encapsulated(hidden) Objects"
 * - An Object called the Invoker transfers this Command to anothe Object called a
